    ...
    function initializeDummyProducts() {
        if (!getProductsFromLocalStorage().length) {
            const dummyProducts = [
                ...
                { id: 'prod-2', name: 'Kemeja Batik Modern', description: 'Kemeja batik katun nyaman dengan motif kontemporer.', price: 350000, category: 'Pakaian', image_url: 'https://dynamic.zacdn.com/0urVQx4lRZaz7zppqVR2X7Vou0s=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/abiroy-5959-1243323-1.jpg' },
                { id: 'prod-3', name: 'Buku Fiksi Ilmiah: Dune', description: 'Novel fiksi ilmiah epik karya Frank Herbert.', price: 120000, category: 'Buku', image_url: 'https://upload.wikimedia.org/wikipedia/id/9/90/Dune_KPG.jpg' },
                { id: 'prod-4', name: 'Lampu Meja Minimalis', description: 'Lampu meja dengan desain modern, cocok untuk ruang kerja.', price: 180000, category: 'Dekorasi Rumah', image_url: 'https://muliamas.co.id/wp-content/uploads/2023/03/lampu-meja-hias-minimalis-ruang-belajar.png' },
                { id: 'prod-5', name: 'Headphone Nirkabel Premium', description: 'Kualitas suara superior dengan pembatalan bising aktif.', price: 1800000, category: 'Elektronik', image_url: 'https://media.dinomarket.com/docs/imgTD/2024-01/DM_3003683395656F43EE54E2B367AB1BAB_220124140126_ll.jpg' },
                { id: 'prod-6', name: 'Celana Jeans Slim Fit', description: 'Celana jeans nyaman dengan potongan modern.', price: 450000, category: 'Pakaian', image_url: 'https://images.tokopedia.net/img/cache/500-square/VqbcmM/2020/10/3/ae365f9f-3295-439c-aded-c36e121e2ed7.jpg' },
                { id: 'prod-7', name: 'Buku Resep Masakan Indonesia', description: 'Kumpulan resep masakan tradisional Indonesia.', price: 95000, category: 'Buku', image_url: 'https://kineruku.com/wp-content/uploads/2017/03/Buku-Mustikarasa2.jpg' },
                { id: 'prod-8', name: 'Tanaman Hias Monstera', description: 'Monstera deliciosa, mempercantik ruangan Anda.', price: 280000, category: 'Dekorasi Rumah', image_url: 'https://static.haluan.co/wp-content/uploads/2023/06/Tanaman-Monstera.-pinteres-1.jpg' },
                { id: 'prod-9', name: 'Smartwatch Canggih', description: 'Smartwatch dengan fitur pelacakan kesehatan dan notifikasi.', price: 1200000, category: 'Elektronik', image_url: 'https://www.garmin.co.id/m/id/g/products/fenix-7-silver-cf-lg.jpg' },
                { id: 'prod-10', name: 'Jaket Bomber Stylish', description: 'Jaket bomber dengan bahan berkualitas tinggi, nyaman dan modis.', price: 600000, category: 'Pakaian', image_url: 'https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//85/MTA-52410260/no_brand_brand_fashion_-_jaket_pria_bomber_terbaru-jaket_bomber_pria_casual-jaket_pria-jaket_full02_nqkjxj8o.jpg' },
                { id: 'prod-11', name: 'Novel Misteri: Sherlock Holmes', description: 'Kumpulan cerita detektif klasik dari Arthur Conan Doyle.', price: 110000, category: 'Buku', image_url: 'https://cdn.gramedia.com/uploads/items/9786237115922_Sherlock-Holmes-Misteri-Di-Lembah-Ketakutan.jpg' },
                { id: 'prod-12', name: 'Cangkir Kopi Keramik', description: 'Set 4 cangkir kopi keramik handmade.', price: 75000, category: 'Dekorasi Rumah', image_url: 'https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//99/MTA-54456407/no-brand_cangkir-kopi-keramik-tea-coffee-cup-spotting_full01.jpg' },
                { id: 'prod-13', name: 'Monitor Gaming Ultra-Wide', description: 'Monitor layar lebar untuk pengalaman gaming imersif.', price: 4500000, category: 'Elektronik', image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkjHEMPsbvGIQcT6uCneMLdX7S5gcLe_OGLA&s' },
                { id: 'prod-14', name: 'Tas Ransel Anti Air', description: 'Tas ransel kokoh dan anti air untuk petualangan.', price: 290000, category: 'Pakaian', image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTo9FLslvJPyvyVNgvXGbQf2aCV4QCh6xXYgg&s' },
                { id: 'prod-15', name: 'Komik Jepang: One Piece', description: 'Serial manga petualangan populer di seluruh dunia.', price: 35000, category: 'Buku', image_url: 'https://upload.wikimedia.org/wikipedia/id/thumb/9/90/One_Piece%2C_Volume_61_Cover_%28Japanese%29.jpg/250px-One_Piece%2C_Volume_61_Cover_%28Japanese%29.jpg' }
            ];
